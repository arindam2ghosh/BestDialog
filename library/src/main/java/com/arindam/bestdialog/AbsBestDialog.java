...
public abstract class AbsBestDialog<T extends AbsBestDialog> {
    ...
    public AbsBestDialog(Context context) {
        this(context, 0);
    }

    public AbsBestDialog(Context context, int theme) {
        this(context, theme, 0);
    }

    public AbsBestDialog(Context context, int theme, int layoutRes) {
        if (layoutRes == 0) {
            layoutRes = getLayout();
        }
        if (theme == 0) {
    ...
    public T setTopAreaVisibility(int val) {
        topView.setVisibility(val);
        return (T) this;
    }
    ...
    public T setTopTitleFontSize(int fontSize) {
        topTitleView.setTextSize(fontSize);
        return (T) this;
    }

    public T setTopTitleStyle(int style) {
        topTitleView.setTypeface(null, style);
        return (T) this;
    }
    ...
    public T setTitleFontSize(int fontSize) {
        titleView.setTextSize(fontSize);
        return (T) this;
    }

    public T setTitleStyle(int style) {
     ...
     * help you in this.
     */
    public T setInstanceStateHandler(int id, BestSaveStateHandler handler) {
    ...
    protected class ClickListenerDecorator implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (clickListener != null) {
                if (clickListener instanceof BestDialogCompat.DialogOnClickListenerAdapter) {
                    BestDialogCompat.DialogOnClickListenerAdapter listener =
                            (BestDialogCompat.DialogOnClickListenerAdapter) clickListener;
